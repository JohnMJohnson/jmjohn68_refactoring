...
import main.java.memoranda.SingleEvent;
...
public class EventsPanel extends JPanel {
	...
	int rtype;
        ...
        EventsManager.createRepeatableEvent(new SingleEvent(rtype, sd, ed, period, hh, mm, text, dlg.workingDaysOnlyCB.isSelected()));
    }
