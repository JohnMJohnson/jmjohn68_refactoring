...
public class TaskTableModel extends AbstractTreeTableModel implements TreeTableModel {
    ...
    public Object getValueAt(Object node, int column) {
        ...
        case 1:
            return t;
        case 2:
            return TaskDate.getStartDate(t.get_element()).getDate();
        case 3:
            if (TaskDate.getEndDate(t.get_element(),t.get_tl(),t) == null)
                return null;
            else
                return TaskDate.getEndDate(t.get_element(),t.get_tl(),t).getDate();        
        case 4:
