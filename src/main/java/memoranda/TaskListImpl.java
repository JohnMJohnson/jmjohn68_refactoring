...
public class TaskListImpl implements ITaskList {
    ...
    public CalendarDate getEarliestStartDateFromSubTasks(ITask t) {
        CalendarDate d = TaskDate.getStartDate(t.get_element());
        if (hasSubTasks(t.getID())) {
	        Collection subTasks = getAllSubTasks(t.getID());
	        for (Iterator iter = subTasks.iterator(); iter.hasNext();) {
	        	ITask e = (ITask) iter.next();
	        ...
	        TaskDate.setStartDate((d), t.get_element());
	        return d;
        }
        else {
            return TaskDate.getStartDate(t.get_element());
        }
    }
    ...
    public CalendarDate getLatestEndDateFromSubTasks(ITask t) {
        CalendarDate d = TaskDate.getEndDate(t.get_element(),t.get_tl(),t);
        if (hasSubTasks(t.getID())) {
	        Collection subTasks = getAllSubTasks(t.getID());
	        for (Iterator iter = subTasks.iterator(); iter.hasNext();) {
	        	ITask e = (ITask) iter.next();
	        ...
	        TaskDate.setEndDate((d), t.get_element());
	        return d;
        }
        else {
            return TaskDate.getEndDate(t.get_element(),t.get_tl(),t);
        }
    }
